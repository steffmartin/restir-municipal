package br.com.smaconsulting.sped.editor.task.importdirf;
...
import static br.com.smaconsulting.sped.editor.util.Util.getReader;
import static br.com.smaconsulting.sped.editor.util.Util.toHMS;
...
//  private DirfService dirfService;
    ...
    protected Map<String, Throwable> call() {
        ...
        if (progress == 0) {
            ...
            updateMessage("Tarefa finalizada! Tempo gasto em " + progress + " DIRFs: " + toHMS(
    ...
    private void importDirf(String fileName) {
        try (BufferedReader dirfFile = getReader(inputDir + fileName, inputCharset)) {
