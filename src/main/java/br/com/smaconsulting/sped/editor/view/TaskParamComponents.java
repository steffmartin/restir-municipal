package br.com.smaconsulting.sped.editor.view;

import br.com.smaconsulting.sped.editor.task.TaskParam;
import br.com.smaconsulting.sped.editor.task.TaskParam.ParamClass;
import br.com.smaconsulting.sped.editor.task.exportreport.SQLOperations;
...
public class TaskParamComponents {
    ...
    private static Region getRegion(TaskParam param) {
        ParamClass paramClass = param.getParamClass();
    ...
    private static Object getObject(Region region) {
        ParamClass paramClass = ((TaskParam) region.getUserData()).getParamClass();
        switch (paramClass) {
            case DATE_AS_TIMESTAMP:
